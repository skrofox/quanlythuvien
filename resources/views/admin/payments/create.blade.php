...
@section('page-title', 'Thêm thanh toán')
            ...
            <form action="{{ route('admin.payments.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="method" id="method" class="form-control @error('method') is-invalid @enderror" required>
                        ...
                        <option value="momo" {{ old('method') == 'momo' ? 'selected' : '' }}>MoMo</option>
                        <option value="paypal" {{ old('method') == 'paypal' ? 'selected' : '' }}>PayPal</option>
                        <option value="credit_card" {{ old('method') == 'credit_card' ? 'selected' : '' }}>Thẻ tín dụng</option>
                        <option value="bank_transfer" {{ old('method') == 'bank_transfer' ? 'selected' : '' }}>Chuyển khoản</option>
                ...
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="form-control @error('status') is-invalid @enderror" required>
                        ...
                        <option value="refunded" {{ old('status') == 'refunded' ? 'selected' : '' }}>Đã hoàn tiền</option>
                    </select>
                    @error('status')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
